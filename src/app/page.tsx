...
import { MyMetadata } from "./components/MyMetadata";
// import LoginModale from "./components/LoginModal";
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>{`${MyMetadata.title ?? "Page d'Accueil"}`}</title>
        <meta
          name="description"
          content={MyMetadata.description ?? "CMS Pour Gestion de Restaurant"}
        />
      </Head>
      <div className={styles.homepageContainer}>
        <section className={styles.heroSection}>
          <div className={styles.heroContent}>
            <h1 className={`${styles.heroTitle} mb-14 `}>
              Bols Inspirés Libanais
            </h1>
        ...
        <section className={styles.introSection}>
          ...
          <p className={styles.introText}>
            CMS Restaurant offre une expérience culinaire unique en fusionnant
            des saveurs traditionnelles et modernes. Nos plats sont préparés
            avec des ingrédients frais et de qualité pour vous garantir une
            satisfaction totale.
          </p>
        </section>
        ...
        <section className={styles.testimonialsSection}>
          <div className={styles.testimonialCard}>
            ...
            <p className={styles.testimonialText}>
              ...
              précieux. Les ingrédients sont de qualité supérieure, et la
              variété des garnitures vous permet de personnaliser votre bol.
            </p>
